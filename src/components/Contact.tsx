          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4 group">
                <div className="w-12 h-12 bg-muted rounded-lg flex items-center justify-center group-hover:bg-primary/20 transition-colors">
            ...
            <div className="pt-8">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-12 h-12 bg-muted rounded-lg flex items-center justify-center hover:bg-primary/20 transition-all duration-300 hover:scale-110 hover:shadow-glow group"
                >
